...
> **⚠️ Nota di correzione — 2026-08-09, feature 002.** L'espressione "sovrastima di circa un quinto" è **ambigua**: ammette due letture aritmetiche e non dichiara quale adotti. Come quota di righe che sono ripetizioni di una traccia già presente vale **21,28%**, e "circa un quinto" è corretto. Come eccesso del totale non deduplicato sul totale corretto vale **27,03%**, e "circa un quinto" non lo è — ed è la lettura che la parola *sovrastima* suggerisce più naturalmente, perché si sovrastima rispetto al valore giusto.
>
