...
| **Riscrittura del criterio di mood per `CF-1` e versione 2 della tabella** | ~1,5 | **prima di `007b`** — vedi [Debito della feature 006](#debito-della-feature-006) |
| Debito testuale della 001: rilievi R9, R10, R12 e allineamento di §3 a R11 | ~1 | prima di `007b` |
| Debito testuale della 002: divergenza 3, allineare §5 del documento di audit a citare D3 della 001 e A2/A3 del business case | ~0,5 | prima di `007b` |
| Debito testuale della 002: portare `docs/data_audit.md` sotto la severità stretta, rimarcandone le quantità | ~1 | prima di `007b`, nella stessa sessione della riga sopra |
