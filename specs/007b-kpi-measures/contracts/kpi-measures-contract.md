...
5. **Lo stato di verifica contro il motore reale è dichiarato per ciascuna misura** (E9, FR-030): «verificato contro il motore reale» è una categoria diversa e più forte di «calcolato da script», e nessuna delle due compare senza che il confronto corrispondente sia realmente avvenuto.
